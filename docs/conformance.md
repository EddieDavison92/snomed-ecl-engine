...
The [1,000-expression corpus](../validation/ecl-1000.json) now evaluates all 1,000 cases, with the previous 960 result sets unchanged. This is workload coverage, not a language-conformance score. Its generated cases omit many combinations and lexical edges. The [official example check](../validation/official-examples-history.json) parses all 121 files. Parsing does not prove correct evaluation.
