...
- Read `docs/plan.md` before implementation. The current prototype imports a compact store and evaluates hierarchy operators. It has no ECL parser or refinement evaluator yet.
