...
SEMANTIC_RULINGS = [
    {"form": "reverse flag inside an attribute group", "example": "* : { R 363698007 = X }",
     ...
     "evidence": "docs/ecl-support.md#open-questions; tests/refinements.rs; IHTSDO/snomed-expression-constraint-language#11 open"},
    {"form": "member filter without a refset operator", "example": "900000000000527005 {{M active=1}}",
     "normative_status": "open", "error": "ParseErrorKind::Semantic",
     "evidence": "docs/ecl-support.md#open-questions; tests/lexical.rs; logical model 4; IHTSDO/snomed-expression-constraint-language#10 open"},
    {"form": "reverse flag with a concrete value", "example": "* : R 1142135004 = #10",
     ...
     "evidence": "docs/ecl-support.md#open-questions; tests/refinements.rs"},
    {"form": "memberOf over reference sets outside the concept domain only", "example": "^ 900000000000508004",
     ...
     "evidence": "docs/ecl-support.md#open-questions; tests/membership.rs; tests/member_filters.rs; tests/compact_store.rs; scripts/check_membership_rf2.py"},
    {"form": "tuple projection inside a subquery", "example": "<< (^[referencedComponentId,mapTarget] X)",
     ...
     "evidence": "docs/ecl-support.md#open-questions; tests/member_filters.rs"},
]
BOUNDARIES = {
